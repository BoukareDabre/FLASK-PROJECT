    ...
    const containerCarrousel = container.querySelector(".containere-carrouselo");
    const carrousel = container.querySelector(".carrouselo");
    const carrouselItems = carrousel.querySelectorAll(".carrouselo-item");
